...
> Read the documented testing standards and the current test suites (unit, integration, e2e, UI, contract) to understand the expected patterns, principles, practices, and standards.  
