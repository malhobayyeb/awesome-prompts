...
This directory hosts the documentation-first workflow for deriving agile requirements, tagging coverage, and summarizing findings for stakeholders. The [repository overview](../README.md) shows how it complements the testing-focused packs.

## Workflow outputs

- Write epics and user stories to `docs/tests/agile-requirements.md` in the project you are documenting.
- Revisit that file as you tag coverage status, add orphaned-code notes, and polish the final stakeholder summary.
